    ...
    public class DBGateway
    {
        ...
        public DBGateway()
        {
            try
            {
                ...
                //conString = "Server=user-hp1;Port=3306;Database=application_mvc_db;Uid=root;password='';Convert Zero Datetime = true";
                conString = "Server=localhost;Port=3306;Database=tikaappdb;Uid=root;password='root';Convert Zero Datetime = true";
               // conString = "Server=amahamudunnabi3;Port=3306;Database=myflexml_test;Uid=razib;password=123456razib;Convert Zero Datetime = true";
                SqlConnectionObj = new MySqlConnection(conString);
                SqlCommandobj = SqlConnectionObj.CreateCommand();
            }
            catch (Exception exception)
            {
                conString = "Server=localhost;Port=3306;Database=application_mvc_db;Uid=razib;password=123456razib;Convert Zero Datetime = true";
                SqlConnectionObj = new MySqlConnection(conString);
                SqlCommandobj = SqlConnectionObj.CreateCommand();
            }
        }
